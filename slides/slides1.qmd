...
::: {.column width="50%"}
![](slides-images/SMI_bino.jpg){width=80%}
...
5:15--5:30  | Thought experiments / bird considerations |




## Preliminaries: What I want you to get out of this workshop {background-image="quarto-static/slideswoosh-white.png" background-size="contain"}
...
I don't expect anyone to be a CKMR expert after taking this workshop.  There are a lot of levels of 
...
Intro [https://pconn.github.io/euring-ckmr-2023/slides/slides1.html](https://pconn.github.io/euring-ckmr-2023/slides/slides1.html)

Genetics/kin-finding [https://pconn.github.io/euring-ckmr-2023/slides/slides1.html](https://pconn.github.io/euring-ckmr-2023/slides/slides2.html)

Statistical theory [https://pconn.github.io/euring-ckmr-2023/slides/slides3.html](https://pconn.github.io/euring-ckmr-2023/slides/slides3.html)

Design [https://pconn.github.io/euring-ckmr-2023/slides/slides4.html](https://pconn.github.io/euring-ckmr-2023/slides/slides4.html)

Thought experiments [https://pconn.github.io/euring-ckmr-2023/slides/slides5.html](https://pconn.github.io/euring-ckmr-2023/slides/slides5.html)

**General workshop github repository**: [https://github.com/pconn/euring-ckmr-2023](https://github.com/pconn/euring-ckmr-2023)

**Site for a previous, full day workshop with more slides, code & examples**: [https://eriqande.github.io/tws-ckmr-2022](https://eriqande.github.io/tws-ckmr-2022)
...
![](slides-images/hair.png)
:::

::: {.column width="50%"}

![](slides-images/goose.jpg){width=80%}
...
![Cartoon credit: M. Bravington](slides-images/CKMR_LP_fish.jpg)
...
![](slides-images/RawdingScreenshot.jpg)
...
![](slides-images/ckmr_process1.png)

## CKMR Workflow {background-image="quarto-static/slideswoosh-white.png" background-size="contain"}

![](slides-images/ckmr_process2.png)
...
![](slides-images/Are_you_my_mother.jpg)
...
## CKMR Assumptions {background-image="quarto-static/slideswoosh-white.png" background-size="contain"}
 ...
 1. Accurate genotyping (no false positive kin pairs!)
...
![](slides-images/einstein.jpg){width=50%}
:::

::: {.column width="50%"}

![](slides-images/money.jpg){width=50%}
...
Paper in prep (Taras, Conn, Quakenbush, Bravington, et al.). Annual sampling of bearded seal subsistence harvests (tissue samples + teeth) by Alaska Dept of Fish and Game.

:::: {.columns}

::: {.column width="50%"}

![](slides-images/bearded_cameron.jpg){width=300}

![](slides-images/bearded_sampling_locations.jpg){width=400}
:::

::: {.column width="50%"}

![](slides-images/bd_skinning_pt_hope.jpg){width=300}
![](slides-images/Samples_per_year_bd.jpg){width=300}
:::
::::
...
* We had $\approx 2500$ tissue samples over 20 
years.
